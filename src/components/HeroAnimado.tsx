...
export default function HeroAnimado() {
  ...
  return (
    <section 
      id="hero-animado" 
      className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 overflow-hidden gradient-blue text-white"
    >
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(255,236,1,0.08),transparent_40%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(6,54,165,0.15),transparent_50%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <motion.div 
              ...
              className="relative w-full max-w-sm aspect-square bg-white/5 rounded-3xl border border-white/10 flex items-center justify-center p-8 overflow-hidden shadow-2xl"
            >
              {/* Abstract decorative graphic */}
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#FFF_1px,transparent_1px)] [background-size:16px_16px]" />
              <div className="w-48 h-48 rounded-full bg-brand-yellow/10 absolute -top-10 -right-10 blur-xl" />
              <div className="w-48 h-48 rounded-full bg-brand-blue/30 absolute -bottom-10 -left-10 blur-xl" />

              <div className="text-center z-10 space-y-4">
                <div className="w-20 h-20 bg-brand-yellow/20 rounded-full flex items-center justify-center mx-auto mb-2 text-brand-yellow">
                  <Bike className="h-10 w-10" />
                </div>
                <p className="font-subheading text-2xl tracking-widest uppercase text-brand-yellow leading-tight">DOSRUEDAS COURIER</p>
                <div className="h-[2px] w-12 bg-white/20 mx-auto" />
                <p className="text-xs text-blue-100 font-sans tracking-wide leading-relaxed">
                  Conectando e-commerce, locales comerciales y envíos particulares de punta a punta en toda la ciudad.
                </p>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-[10px] font-bold uppercase tracking-wider text-brand-yellow">
