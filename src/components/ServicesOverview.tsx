...
export default function ServicesOverview() {
  ...
  return (
    <section id="services-overview" className="py-24 bg-slate-50 relative overflow-hidden">
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="px-2.5 py-1 rounded-md text-[10px] font-bold tracking-widest uppercase bg-slate-100 text-slate-500">
                      {service.badge}
                    </span>
                  </div>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <Link 
                    href={service.href}
                    className="h-11 w-11 rounded-xl bg-slate-50 text-slate-700 hover:text-brand-blue hover:bg-brand-blue/5 flex items-center justify-center transition-all group-hover:translate-x-1"
                  >
